...
def page_summary_body():
    ...
    st.info(
        ...
        f"Our client **Farmy and Foods** is dealing with powdery mildew on their"
        ...
        f"Farmy and Foods' current method of detecting whether a particular"
    ...
    st.write(
        ...
        f" were collected from Farmy and Foods' farms. The 4208 photos of"
    ...
    st.success(
        ...
        f"* 2. Farmy and Foods wants to know if the cherry leaf"
